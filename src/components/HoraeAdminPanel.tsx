  ...
  return (
    <div className="space-y-6" id="horae-admin-container">
      ...
      <AnimatePresence>
        ...
        {resetPwdUser && (
          <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center z-50 p-4" id="reset-password-modal">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.95 }}
            ...
            >
              ...
              <div className="text-center space-y-2 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-800">Reset User Password</h3>
                <p className="text-xs text-slate-500">
                  Set a new password for <span className="font-bold text-slate-800">{resetPwdUser.name}</span> ({resetPwdUser.email || resetPwdUser.phoneNumber})
                </p>
              </div>
                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full text-xs pl-3 pr-10 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all font-semibold"
                    />
                    <button
                      type="button"
                      onClick={() => setShowResetPwdToggle(!showResetPwdToggle)}
                      className="absolute right-3 top-2.5 text-slate-400 hover:text-slate-600 focus:outline-none cursor-pointer flex items-center h-5"
                    >
                      {showResetPwdToggle ? (
