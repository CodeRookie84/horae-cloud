...
async function createCaptureAndReply(
  ...
  // NOTE: the transcript is stored as-is (native script). Transliteration to Latin
  // happens keyless in the browser when the task form auto-fills from this capture
  // (see TaskManagerWorkflows prefill) — no server-side key/dependency here.
